...
@section('content')
    ...
    <div class="flex gap-16 px-16 py-4">
        ...
        <div class="card flex gap-8 flex-grow justify-between">
            ...
            <img src="{{asset('images/barang_icon_black.svg')}}" alt="kategori icon" class="opacity-25 w-8">
        </div>
        <div class="card flex gap-8 flex-grow justify-between">
            <div>
            ...
            <img src="{{asset('images/barang_masuk_icon_black.svg')}}" alt="kategori icon" class="opacity-25 w-8">
        </div>
        <div class="card flex gap-8 flex-grow justify-between">
            <div>
            ...
            <img src="{{asset('images/barang_keluar_icon_black.svg')}}" alt="kategori icon" class="opacity-25 w-8">
        </div>
    </div>
@endsection
